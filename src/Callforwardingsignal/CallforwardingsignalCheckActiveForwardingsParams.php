 ...
 *
 * @see Camara\Services\CallforwardingsignalService::checkActiveForwardings()
 *
 * @phpstan-type CallforwardingsignalCheckActiveForwardingsParamsShape = array{
 *   phoneNumber?: string|null, xCorrelator?: string|null
 * }
 */
final class CallforwardingsignalCheckActiveForwardingsParams implements BaseModel
{
    /** @use SdkModel<CallforwardingsignalCheckActiveForwardingsParamsShape> */
    use SdkModel;
    use SdkParams;

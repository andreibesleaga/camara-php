 ...
 *
 * @see Camara\Services\DeviceswapService::retrieveDate()
 *
 * @phpstan-type DeviceswapRetrieveDateParamsShape = array{
 *   phoneNumber?: string|null, xCorrelator?: string|null
 * }
 */
final class DeviceswapRetrieveDateParams implements BaseModel
{
    /** @use SdkModel<DeviceswapRetrieveDateParamsShape> */
    use SdkModel;
    use SdkParams;

...
use Camara\Deviceroamingstatus\Subscriptions\DeviceRoamingStatusSubscription\Status;
 ...
 *
 * @phpstan-type DeviceRoamingStatusSubscriptionShape = array{
 *   id: string,
 ...
 * }
 */
final class DeviceRoamingStatusSubscription implements BaseModel
{
    /** @use SdkModel<DeviceRoamingStatusSubscriptionShape> */
    use SdkModel;
    ...
    /**
     * `new DeviceRoamingStatusSubscription()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * DeviceRoamingStatusSubscription::with(
     ...
     *
     * ```
     * (new DeviceRoamingStatusSubscription)
     *   ->withID(...)
     *   ->withConfig(...)
     *   ->withProtocol(...)
     *   ->withSink(...)

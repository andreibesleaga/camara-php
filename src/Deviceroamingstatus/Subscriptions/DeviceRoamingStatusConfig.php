...
use Camara\Deviceroamingstatus\Subscriptions\DeviceRoamingStatusConfig\SubscriptionDetail;
 ...
 *
 * @phpstan-import-type SubscriptionDetailShape from \Camara\Deviceroamingstatus\Subscriptions\DeviceRoamingStatusConfig\SubscriptionDetail
 *
 * @phpstan-type DeviceRoamingStatusConfigShape = array{
 ...
 * }
 */
final class DeviceRoamingStatusConfig implements BaseModel
{
    /** @use SdkModel<DeviceRoamingStatusConfigShape> */
    use SdkModel;
    ...
    /**
     * `new DeviceRoamingStatusConfig()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * DeviceRoamingStatusConfig::with(subscriptionDetail: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new DeviceRoamingStatusConfig)->withSubscriptionDetail(...)
     * ```
     */

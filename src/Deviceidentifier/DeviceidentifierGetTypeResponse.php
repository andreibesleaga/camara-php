...
use Camara\Deviceidentifier\DeviceidentifierGetTypeResponse\Device;

/**
 * @phpstan-import-type DeviceShape from \Camara\Deviceidentifier\DeviceidentifierGetTypeResponse\Device
 *
 * @phpstan-type DeviceidentifierGetTypeResponseShape = array{
 ...
 * }
 */
final class DeviceidentifierGetTypeResponse implements BaseModel
{
    /** @use SdkModel<DeviceidentifierGetTypeResponseShape> */
    use SdkModel;

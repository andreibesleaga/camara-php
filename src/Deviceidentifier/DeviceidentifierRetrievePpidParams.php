...
use Camara\Deviceidentifier\DeviceidentifierRetrievePpidParams\Device;

/**
 * Get a pseudonymous identifier for device being used by a given mobile subscriber.
 *
 * @see Camara\Services\DeviceidentifierService::retrievePpid()
 *
 * @phpstan-import-type DeviceShape from \Camara\Deviceidentifier\DeviceidentifierRetrievePpidParams\Device
 *
 * @phpstan-type DeviceidentifierRetrievePpidParamsShape = array{
 *   device?: null|Device|DeviceShape, xCorrelator?: string|null
 * }
 */
final class DeviceidentifierRetrievePpidParams implements BaseModel
{
    /** @use SdkModel<DeviceidentifierRetrievePpidParamsShape> */
    use SdkModel;
    use SdkParams;

...
use Camara\Connectednetworktype\Subscriptions\ConnectedNetworkTypeSubscription\Status;
 ...
 *
 * @phpstan-type ConnectedNetworkTypeSubscriptionShape = array{
 *   id: string,
 ...
 * }
 */
final class ConnectedNetworkTypeSubscription implements BaseModel
{
    /** @use SdkModel<ConnectedNetworkTypeSubscriptionShape> */
    use SdkModel;
    ...
    /**
     * `new ConnectedNetworkTypeSubscription()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ConnectedNetworkTypeSubscription::with(
     ...
     *
     * ```
     * (new ConnectedNetworkTypeSubscription)
     *   ->withID(...)
     *   ->withConfig(...)
     *   ->withProtocol(...)
     *   ->withSink(...)

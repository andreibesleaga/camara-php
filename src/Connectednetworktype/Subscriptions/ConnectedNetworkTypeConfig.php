...
use Camara\Connectednetworktype\Subscriptions\ConnectedNetworkTypeConfig\SubscriptionDetail;
 ...
 *
 * @phpstan-import-type SubscriptionDetailShape from \Camara\Connectednetworktype\Subscriptions\ConnectedNetworkTypeConfig\SubscriptionDetail
 *
 * @phpstan-type ConnectedNetworkTypeConfigShape = array{
 ...
 * }
 */
final class ConnectedNetworkTypeConfig implements BaseModel
{
    /** @use SdkModel<ConnectedNetworkTypeConfigShape> */
    use SdkModel;
    ...
    /**
     * `new ConnectedNetworkTypeConfig()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ConnectedNetworkTypeConfig::with(subscriptionDetail: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ConnectedNetworkTypeConfig)->withSubscriptionDetail(...)
     * ```
     */

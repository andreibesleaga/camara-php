...
use Camara\Devicelocation\Subscriptions\DeviceLocationDevice\Ipv4Address;
 ...
 *
 * @phpstan-import-type Ipv4AddressShape from \Camara\Devicelocation\Subscriptions\DeviceLocationDevice\Ipv4Address
 *
 * @phpstan-type DeviceLocationDeviceShape = array{
 ...
 * }
 */
final class DeviceLocationDevice implements BaseModel
{
    /** @use SdkModel<DeviceLocationDeviceShape> */
    use SdkModel;
